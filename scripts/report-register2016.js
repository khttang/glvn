            ...
            User.find({'userType': 'STUDENT'}, function (err, users) {
                if (!err) {
                    ...
                    stream.once('open', function (fd) {
                        stream.write('ID|Status|FirstName|LastName|BirthDate|FatherName|MotherName|Address|Phone|Email|RegYear|SchoolGrade|VNClass|GLClass|RegFee|RegExempt|Check#\n');
                        for (var k = 0, len10 = registered2016.length; k < len10; k++) {
                            ...
                            stream.write(
                                registered2016[k].username+'|' + registered2016[k].reg2016.status+'|'+
                                ...
                                registered2016[k].reg2016.glClass + '|' + registered2016[k].reg2016.regFee + '|' + registered2016[k].reg2016.regTeacherExempt + '|' +
